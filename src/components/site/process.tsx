  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        ...
        <ol className="relative mt-14 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          {steps.map((step, index) => (
            <li
              key={step.title}
              className="relative rounded-2xl border border-border/60 bg-card p-6 ring-1 ring-foreground/5"
            >
