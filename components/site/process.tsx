...
const steps = [
  ...
  {
    icon: ClipboardList,
    title: "סקר והצעת מחיר",
    description:
      "סקר מפורט באתר, הערכת לוחות זמנים והיבטים רגולטוריים, הצעת מחיר עם פירוט וגבולות אחריות.",
  },
  {
    icon: Wrench,
    title: "ביצוע במינימום השבתה",
    description:
      "עבודה נקייה ובטוחה, תכנון לוחות זמנים שמתחשב בייצור, זמינות בשעות שיא וסופי שבוע — בלי לפגוע בקווי הייצור.",
  },
  {
    icon: ShieldCheck,
    title: "אחריות",
